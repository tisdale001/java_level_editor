...
public class MovingColumnTileGridPanel extends JPanel {
    private int tileWidth;
    private int tileHeight;
    private int numRows;
    private int numCols;
    private ArrayList<MovingColumnTile> tileArr;
    private LevelEditor levelEditor;

    public MovingColumnTileGridPanel(LevelEditor levelEditor, ArrayList<MovingColumnTile> tileArr, int numCols, int tileWidth, int tileHeight) {
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                if (SwingUtilities.isLeftMouseButton(e)) {
                    ...
                    MovingColumnTileGridPanel.this.levelEditor.setCurMovingColumnTile(tileID);
